...
import hemath.com.search.Adapters.*;
 ...
 */
public class MaterialBackWithoutSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    public static final int BUTTON_TOP_MENU = 4;
    ...
    public MaterialBackWithoutSearchBar(Context context,AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
    }

    public MaterialBackWithoutSearchBar(Context context,AttributeSet attrs,int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MaterialBackWithoutSearchBar(Context context,AttributeSet attrs,int defStyleAttr,int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(attrs);
    }

    private void init(AttributeSet attrs) {
        inflate(getContext(), R.layout.activity_material_without_search, this);
    ...
    private void setupIcons() {
        //Drawables
        //Animated Nav Icon
        navIconResId = R.drawable.ic_arrow_left_black_48dp;
...
//                onSearchActionListener.onButtonClicked(BUTTON_SPEECH);
        ...
        } else if (id == R.id.mt_menu)
        {
            ...
            onSearchActionListener.onButtonClicked(BUTTON_TOP_MENU);
    ...
    private static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new Creator<MaterialBackWithoutSearchBar.SavedState>() {
            @Override
            public MaterialBackWithoutSearchBar.SavedState createFromParcel(Parcel source) {
                return new MaterialBackWithoutSearchBar.SavedState(source);
            }

            @Override
            public MaterialBackWithoutSearchBar.SavedState[] newArray(int size) {
                return new MaterialBackWithoutSearchBar.SavedState[size];
            }
        };
