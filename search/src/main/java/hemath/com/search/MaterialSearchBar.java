...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    public void onClick(View v) {
        ...
        if (id == getId()) {
            ...
            disableSearch();
            if (listenerExists())
                onSearchActionListener.onButtonClicked(BUTTON_INTENT_BACK);
